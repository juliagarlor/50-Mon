![Title](screenshots/Header.png)

# 50-Mon

Explore a world of fantastic creatures with your team mate. Take care of each other you in your journey around the world. This is a very simple demo with just a small view, that will grow with time. Hope you enjoy this small sample.
...
```
git clone https://github.com/juliagarlor/50-Mon.git
```
...
![Battle2](screenshots/Fight2.png)
...
Please, make sure to check the lecture to develop this project in the following link: https://youtu.be/OUDNncXB950

Regarding to this flappy-bird version, any feedback for improvement is welcome, and I hope you have fun using it.


![Battle1](screenshots/Fight1.png)
