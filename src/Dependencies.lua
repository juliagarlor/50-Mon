...
require 'src/states/game/UpdateMenuState'
...
['trainer'] = love.graphics.newImage('graphics/pokemon-trainer.png'),
['trainer-back'] = love.graphics.newImage('graphics/trainer-back.png'),
['cursor'] = love.graphics.newImage('graphics/cursor.png'),

['aardont-back'] = love.graphics.newImage('graphics/pokemon/aardont-back.png'),
['aardont-front'] = love.graphics.newImage('graphics/pokemon/aardont-front.png'),
['budaye-back'] = love.graphics.newImage('graphics/pokemon/budaye-back.png'),
['budaye-front'] = love.graphics.newImage('graphics/pokemon/budaye-front.png'),
...
['trainer'] = GenerateQuads(gTextures['trainer'], 16, 16)
}
