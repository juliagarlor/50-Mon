...
self.sprite = POKEMON_DEFS[POKEMON_IDS[math.random(1, #POKEMON_IDS)]].battleSpriteFront
...
if love.keyboard.wasPressed('enter') or love.keyboard.wasPressed('return') then
	gStateStack:push(FadeInState({
		...
		"Welcome to the world of 50Mon! To start fighting monsters with you own randomly assigned" ..
...
love.graphics.printf('Press Enter', 0, VIRTUAL_HEIGHT/2 + 60, VIRTUAL_WIDTH, 'center')
